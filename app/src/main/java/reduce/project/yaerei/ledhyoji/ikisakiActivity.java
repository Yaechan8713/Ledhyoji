...
/**
 * Created by yaerei on 2018/02/16.
 */

public class ikisakiActivity extends AppCompatActivity {
...
//      trainfromは行先を表示するImageView
        ...
        timeredit = (EditText)findViewById(R.id.timeredit);
...
//        noikisakinum = R.drawable.noikisaki;
    ...
    public void dialog(){
        new AlertDialog.Builder(ikisakiActivity.this)
                .setTitle("処理されていますか?")
                .setMessage("処理が成功しましたか？")
                .setPositiveButton(
                        "成功",
    ...
    public void timereset(){
        ...
        repeattime = Integer.valueOf(timeredit.getText().toString());
    ...
    public void repeattimer(View v){
        ...
        new AlertDialog.Builder(ikisakiActivity.this)
                .setTitle("保存")
                .setMessage(repeattime + "秒間隔で言語を切り替えますがよろしいですか？")
                .setPositiveButton(
                        R.string.ryoukai,
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                SharedPreferences sps = getSharedPreferences("time", Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = sps.edit();
                                editor.putInt("timer",repeattime);
                                editor.commit();
